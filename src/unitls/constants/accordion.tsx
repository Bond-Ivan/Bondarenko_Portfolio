...
const accordionElems = [{
    ...
    timeKey: "firstItem.time",
    logo: Raiffeisenbank,
    alt: "Логотип кампании Райфайзенбанк",
    link: "https://www.raiffeisen.ru/",
    linkText: "Raiffeisen.ru",
    description: "Создавал интерфейсы на React и TypeScript, занимался оптимизацией, исправлением багов и интеграцией с бекендом для плавной работы.",
...
{
    title: "Тестировщик",
    timeKey: "secondItem.time",
    logo: Domrf,
    alt: "Логотип кампании Дом РФ",
    link: "https://domrfbank.ru/",
    linkText: "Дом.рф",
    description: "Выполнял ручное тестирование, разрабатывал тестовые сценарии. Написание тест кейсов.",
...
{
    title: "Репетитор по SQL",
    timeKey: "thirdItem.time",
    logo: Gubkin,
    alt: "Логотип Губкинского университета",
    link: "https://bond-ivan.github.io/Bondarenko_Portfolio/",
    linkText: "Bond-Ivan",
    description: "Выполнение лабораторных и курсовых работ различной сложности, используя язык запросов SQL",
